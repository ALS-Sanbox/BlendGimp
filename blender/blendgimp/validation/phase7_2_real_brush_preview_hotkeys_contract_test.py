...
checks = {
    ...
    "ipc version": 'BLENDGIMP_VERSION = "0.5.18"' in IPC,
    "gimp version": 'BLENDGIMP_VERSION = "0.5.18"' in GIMP,
    "gimp preview function": "def gimp_get_brush_preview" in GIMP,
    "real gimp mask api": "brush.get_mask(max_size, max_size, None)" in GIMP,
    ...
    "gpu mask texture": 'gpu.types.GPUTexture((width, height), format="RGBA8"' in PAINT,
...
print(f"BlendGimp 0.5.18 real brush preview/hotkeys contract: {len(checks)}/{len(checks)} PASS")
