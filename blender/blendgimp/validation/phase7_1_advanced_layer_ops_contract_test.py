...
# 0.5.7 Phase 7.1 release identity
check("manifest version 0.5.7", 'version = "0.5.7"' in manifest)
check("IPC version 0.5.7", 'BLENDGIMP_VERSION = "0.5.7"' in ipc)
check("advanced-layer-ops build id", 'BUILD_ID = "7.1-advanced-layer-ops"' in paint)
check("entry point identifies 0.5.7", '0.5.7 — Phase 7.1 Advanced Layer Operations' in init)
check("main panel identifies Phase 7.1", 'BlendGimp 0.5.7 — Phase 7.1 Advanced Layer Ops' in main)
...
check("GIMP component version 0.5.7", 'BLENDGIMP_VERSION = "0.5.7"' in gimp)
